...
def importdata(TRAIN_NUM):
    ...
    adjusted_value = 1./math.sqrt(32*32*3)
...
def BuildModel(firstlayerdepth, secondlayerdepth, thirdlayerdepth):
    model = Sequential()
    model.add(Conv2D(firstlayerdepth,(5, 5),strides=(1,1),input_shape=(32, 32, 3),padding='valid',activation='relu',kernel_initializer='uniform'))  
    ...
    model.add(Conv2D(thirdlayerdepth,(3, 3),strides=(1,1), padding='valid',activation='relu',kernel_initializer='uniform'))
    model.add(MaxPooling2D(pool_size=(2, 2),strides=(2,2)))
    model.add(BatchNormalization())
...
#===========Train Model===================
def trainmodel(FIRST_LAYER_DEPTH, SECOND_LAYER_DEPTH,THIRD_LAYER_DEPTH, BATCHSIZE, TRAIN_NUM):
	x_train, y_train, x_test, y_test = importdata(TRAIN_NUM)

	model = BuildModel(FIRST_LAYER_DEPTH, SECOND_LAYER_DEPTH, THIRD_LAYER_DEPTH)
	print "first layer: " + str(FIRST_LAYER_DEPTH)
	print "second layer: " + str(SECOND_LAYER_DEPTH)
	print "third layer: " + str(THIRD_LAYER_DEPTH)
	...
	filepath = "modified_noise_data/" + str(BATCHSIZE) + str(TRAIN_NUM) + "noise-weights-improvement-"+"firstlayer-"+str(FIRST_LAYER_DEPTH)+"-secondlayer-"+str(SECOND_LAYER_DEPTH)+ "-thirdlayer-"+ str(THIRD_LAYER_DEPTH) +"-conn-{epoch:02d}.hsf5"
	...
	if EXCESSRISK == True:
        ...
        accpath = "modified_noise_data/" + str(BATCHSIZE) + str(TRAIN_NUM) + "noise-acc_history_conn_net" + "firstlayer-"+str(FIRST_LAYER_DEPTH)+"-secondlayer-"+str(SECOND_LAYER_DEPTH) + "-thirdlayer-"+ str(THIRD_LAYER_DEPTH) + ".txt"
        valpath = "modified_noise_data/" + str(BATCHSIZE) + str(TRAIN_NUM) + "noise-val_acc_history_conn_net" + "firstlayer-"+str(FIRST_LAYER_DEPTH)+"-secondlayer-"+str(SECOND_LAYER_DEPTH) + "-thirdlayer-"+ str(THIRD_LAYER_DEPTH) + ".txt"
...
#trainmodel(16,20,20,32,10000)
#trainmodel(20,20,20,32,10000)
#trainmodel(20,96,96,32,10000)
trainmodel(96,96,96,32,10000)
#
#
#trainmodel(16,20,20,64,10000)
#trainmodel(20,20,20,64,10000)
#trainmodel(20,96,96,64,10000)
#trainmodel(96,96,96,64,10000)
#
#trainmodel(16,20,20,32,25000)
#trainmodel(20,20,20,32,25000)
#trainmodel(20,96,96,32,25000)
#trainmodel(96,96,96,32,25000)
#
#trainmodel(16,20,20,64,25000)
#trainmodel(20,20,20,64,25000)
#trainmodel(20,96,96,64,25000)
#trainmodel(96,96,96,64,25000)
